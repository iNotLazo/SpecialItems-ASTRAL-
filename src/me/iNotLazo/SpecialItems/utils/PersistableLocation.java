...
public class PersistableLocation implements ConfigurationSerializable, Cloneable
{
    ...
    public PersistableLocation(final Location location) {
        ...
        Preconditions.checkNotNull(location.getWorld(), (Object)"Locations' world cannot be null");
    ...
    public World getWorld() {
        Preconditions.checkNotNull(this.worldUID, (Object)"World UUID cannot be null");
        Preconditions.checkNotNull(this.worldName, (Object)"World name cannot be null");
        if (this.world == null) {
